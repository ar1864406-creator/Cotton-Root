...
export const metadata: Metadata = {
  title: {
    default: "Cotton Root | Premier Apparel Sourcing & Supply Chain Hub Pakistan",
    template: "%s | Cotton Root"
  },
  description: 'Cotton Root is Faisalabad’s leading strategic apparel sourcing partner. We provide end-to-end supply chain management, high-volume knitwear manufacturing, and multi-market export expertise for global brands.',
  keywords: [
    "Apparel Sourcing Pakistan",
    "Textile Manufacturing Faisalabad",
    "Garment Export Hub Pakistan",
    "B2B Apparel Sourcing",
    "Supply Chain Management Textile",
    "Knitwear Manufacturers Pakistan",
    "Woven Sourcing Pakistan",
    "Cotton Root Sourcing"
  ],
  authors: [{ name: "Cotton Root Sourcing Team" }],
  creator: "Cotton Root",
  publisher: "Cotton Root",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://cottonroot.com",
    title: "Cotton Root | Strategic Apparel Sourcing Partner",
    description: "Architecting the future of global apparel sourcing with precision and strategic scale from Pakistan's textile capital.",
    siteName: "Cotton Root",
  },
  twitter: {
    card: "summary_large_image",
    title: "Cotton Root | Strategic Apparel Sourcing Partner",
    description: "Premier apparel sourcing and supply chain excellence in Faisalabad, Pakistan.",
    creator: "@cottonroot",
  },
  robots: {
    index: true,
